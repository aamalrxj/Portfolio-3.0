      ...
      >
        ...
        <div style={{ flex: 1, textAlign: 'center', padding: '0 2.5rem', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          <ul style={{
            ...
            <li><strong>Python & Data Analytics:</strong> Introduction to Data Science (Cisco Network Academy)</li>
            <li><strong>Cybersecurity:</strong> Introduction to Cyber Security (Cisco Network Academy)</li>
            <li><strong>Soft Skills:</strong> Presentation Skills, Communication Skills (TCS ION)</li>
          </ul>
        </div>
